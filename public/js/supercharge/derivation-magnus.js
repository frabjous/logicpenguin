...
///////////////// supercharge/derivation-magnus.js ///////////////////
// adds line checking to magnus derivation problems                 //
/////////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import magnusDerivCheck from '../checkers/derivation-magnus.js';
...
export function chargeup(probelem) {
  ...
  probelem.checkLines = async function() {
    ...
    const ind = await magnusDerivCheck(
