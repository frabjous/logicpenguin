...
///////////////// supercharge/derivation-leeds.js ///////////////////
// adds line checking to leeds derivation problems                 //
/////////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import leedsDerivCheck from '../checkers/derivation-leeds.js';
...
export function chargeup(probelem) {
  ...
  probelem.checkLines = async function() {
    ...
    const ind = await leedsDerivCheck(
