...
///////////////// supercharge/derivation-bristol.js ///////////////////
// adds line checking to bristol derivation problems                 //
///////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import bristolDerivCheck from '../checkers/derivation-bristol.js';
...
export function chargeup(probelem) {
  ...
  probelem.checkLines = async function() {
    ...
    const ind = await bristolDerivCheck(
