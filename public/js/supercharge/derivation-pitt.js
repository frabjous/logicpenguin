...
///////////////// supercharge/derivation-pitt.js ///////////////////
// adds line checking to pitt derivation problems                 //
/////////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import pittDerivCheck from '../checkers/derivation-pitt.js';
...
export function chargeup(probelem) {
    ...
    probelem.checkLines = async function() {
        ...
        const ind = await pittDerivCheck(
