...
///////////////// supercharge/derivation-uconn.js ///////////////////
// adds line checking to uconn derivation problems                 //
/////////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import uconnDerivCheck from '../checkers/derivation-uconn.js';
...
export function chargeup(probelem) {
  ...
  probelem.checkLines = async function() {
    ...
    const ind = await uconnDerivCheck(
