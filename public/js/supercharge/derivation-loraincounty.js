...
///////////////// supercharge/derivation-loraincounty.js ///////////////////
// adds line checking to loraincounty derivation problems                 //
/////////////////////////////////////////////////////////////////////////

import { addelem, htmlEscape } from '../common.js';
import loraincountyDerivCheck from '../checkers/derivation-loraincounty.js';
...
export function chargeup(probelem) {
  ...
  probelem.checkLines = async function() {
    ...
    const ind = await loraincountyDerivCheck(
